  ...
  <div class="h-full flex justify-center items-center">
    ...
    <div class="md:w-1/2 w-10/12">
      ...
      <div class="welcome_btn flex justify-center mt-5">
        @if (Auth::check())
        <a href="{{ route('diagnose.index') }}" class="w-max p-2 px-4 flex items-center space-x-1 rounded-full bg-blue-700 hover:bg-blue-500 transition-colors duration-100 ease-in-out z-50">
