...
<head>
  ...
  <title>JagungQu Dashboard | @yield('title_db')</title>
  <script src="https://cdn.tailwindcss.com"></script>
  <script src="http://tailwindcss.com"></script>
  <link rel="shortcut icon" href="{{ asset('images/logo_dashboard/logo.svg') }}" type="image/x-icon">
  <script defer type="module" src="{{ asset('dashboard_js/index.js') }}"></script>
  ...
  <style type="text/tailwindcss">
    ...
    @layer components {
      h1 {
          @apply text-2xl mt-4 mb-4 font-bold;
      }

      h2 {
          @apply text-xl mt-5 mb-5 font-bold;
      }

      h3 {
          @apply text-lg mt-6 mb-6 font-bold;
      }

      h4 {
          @apply mt-7 mb-7 font-bold;
      }

      h5 {
          @apply text-sm mt-8 mb-8 font-bold;
      }

      h6 {
          @apply text-xs mt-9 mb-9 font-bold;
      }
    }
